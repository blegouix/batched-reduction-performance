...
public:
  static void run(benchmark::State &state) {
    ...
    cuda::std::mdspan<double, cuda::std::extents<std::size_t, M, N>,
                      wrapper::mdspan_layout_t<Layout>>
...
#define BENCHMARKS(M, N)                                                         \
  BENCHMARK(BatchedReductionBenchmark<                                           \
            ...
            wrapper::LayoutEnum::Right>::run);                                   \
  BENCHMARK(BatchedReductionBenchmark<                                           \
            M, N, batched_reduction_operator::Sequential<BlockDim1D>,            \
            wrapper::LayoutEnum::Left>::run);                                    \
  BENCHMARK(BatchedReductionBenchmark<                                           \
            M, N, batched_reduction_operator::Sequential<BlockDim1D>,            \
            wrapper::LayoutEnum::RightStride>::run);                             \
  BENCHMARK(BatchedReductionBenchmark<                                           \
            M, N, batched_reduction_operator::Sequential<BlockDim1D>,            \
            wrapper::LayoutEnum::LeftStride>::run);                              \
  /*                                                                             \
    BENCHMARK(                                                                   \
